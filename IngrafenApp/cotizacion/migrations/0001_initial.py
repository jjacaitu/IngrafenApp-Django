# Generated by Django 2.1.1 on 2018-10-15 15:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ADM', 'ADMINISTRADOR'), ('VEN', 'VENDEDOR'), ('COT', 'COTIZADOR'), ('PRO', 'PRODUCCION')], default='ADM', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material2', models.CharField(blank=True, max_length=30, null=True)),
                ('medida_alto_2', models.FloatField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(99)])),
                ('medida_ancho_2', models.FloatField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(99)])),
                ('descripcion_material2', models.CharField(blank=True, max_length=30, null=True)),
                ('impresion_tiro2', models.CharField(blank=True, max_length=30, null=True)),
                ('impresion_retiro2', models.CharField(blank=True, max_length=30, null=True)),
                ('uv2', models.CharField(blank=True, max_length=30, null=True)),
                ('laminado2', models.CharField(blank=True, max_length=30, null=True)),
                ('troquelado2', models.CharField(blank=True, max_length=30, null=True)),
                ('material3', models.CharField(blank=True, max_length=30, null=True)),
                ('medida_alto_3', models.FloatField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(99)])),
                ('medida_ancho_3', models.FloatField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(99)])),
                ('descripcion_material3', models.CharField(blank=True, max_length=30, null=True)),
                ('impresion_tiro3', models.CharField(blank=True, max_length=30, null=True)),
                ('impresion_retiro3', models.CharField(blank=True, max_length=30, null=True)),
                ('uv3', models.CharField(blank=True, max_length=30, null=True)),
                ('laminado3', models.CharField(blank=True, max_length=30, null=True)),
                ('troquelado3', models.CharField(blank=True, max_length=30, null=True)),
